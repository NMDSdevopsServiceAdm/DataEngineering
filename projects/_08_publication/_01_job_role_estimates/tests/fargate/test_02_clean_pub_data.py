...
class TestMain:
    @patch(f"{PATCH_PATH}.cUtils.cqc_location_import_date_filter_expr")
    ...
    def test_main_runs(
        ...
        cqc_location_import_date_filter_expr_mock: Mock,
    ):
        ...
        cqc_location_import_date_filter_expr_mock.assert_called_once_with()
        merged_lf.filter.assert_called_once_with(
            cqc_location_import_date_filter_expr_mock.return_value
        )
