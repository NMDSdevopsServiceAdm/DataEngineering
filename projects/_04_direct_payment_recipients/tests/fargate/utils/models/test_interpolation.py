...
class TestDPRModelInterpolation(unittest.TestCase):
    def test_model_interpolation_completes(self):
        rows = [
            ("area_1", 2021, 300.0, 0.3, 0.3),
            ("area_2", 2021, 300.0, 0.4, 0.4),
            ("area_1", 2020, None, None, 0.3375),
            ("area_2", 2020, 300.0, 0.35, 0.35),
            ("area_1", 2019, 300.0, 0.375, 0.375),
            ("area_2", 2019, 300.0, 0.2, 0.2),
        ]
        test_schema = {
    ...
    #         [
    #             DP.LA_AREA: pl.String,
    #             DP.YEAR_AS_INTEGER, IntegerType(), True),
    ...
    #         [
    #             DP.LA_AREA, StringType(), False),
    #             DP.FIRST_SUBMISSION_YEAR, IntegerType(), True),
    ...
    #         [
    #             DP.LA_AREA, StringType(), False),
    #             DP.INTERPOLATION_YEAR, IntegerType(), True),
    #         ]
    #     )
