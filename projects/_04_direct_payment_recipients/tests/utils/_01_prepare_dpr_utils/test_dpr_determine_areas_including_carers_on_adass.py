...
class TestDetermineAreasIncludingCarers(SparkBaseTest):
    ...
    def test_determine_areas_including_carers_on_adass_completes(self):
        rows = [
            ("area_1", 2021, 300.0, 200.0, 5.0, 100.0, 50.0, 0.5),
            ("area_2", 2021, 300.0, 100.0, 10.0, 100.0, 25.0, None),
            ("area_3", 2020, 300.0, 200.0, 5.0, 100.0, 50.0, None),
            ("area_4", 2020, 300.0, 200.0, 5.0, 100.0, 50.0, None),
            ("area_5", 2019, 300.0, 200.0, 5.0, 100.0, 50.0, None),
            ("area_6", 2019, 300.0, 200.0, 5.0, 100.0, 50.0, None),
        ]
    ...
    def test_determine_areas_including_carers_on_adass_returns_correct_columns(
        ...
        rows = [
            ...
            ("area_3", 2020, 300.0, 200.0, 5.0, 100.0, 50.0, None),
            ("area_4", 2020, 300.0, 200.0, 5.0, 100.0, 50.0, None),
            ("area_5", 2019, 300.0, 200.0, 5.0, 100.0, 50.0, 0.5),
            ("area_6", 2019, 300.0, 200.0, 5.0, 100.0, 50.0, None),
        ]
        test_schema = StructType(
            [
