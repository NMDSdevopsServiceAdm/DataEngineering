...
class TestRollingSum:
    @pytest.fixture(
        params=[
            pytest.param(
                [
                    ("1000",datetime(2024, 1, 1, 0, 0),"care_home_with_nursing", "care_worker", 1.0, 1.0),
                    ("1000",datetime(2024, 1, 1, 0, 0),"care_home_with_nursing", "registered_nurse", 2.0, 2.0),
                    ("1000",datetime(2024, 1, 1, 0, 0),"care_home_with_nursing", "senior_care_worker", 3.0, 3.0),
                    ("1000",datetime(2024, 1, 1, 0, 0),"care_home_with_nursing", "senior_management", 4.0, 4.0),
                    ("1000",datetime(2024, 1, 2, 0, 0),"care_home_with_nursing", "care_worker", None, 1.0),
                    ("1000",datetime(2024, 1, 2, 0, 0),"care_home_with_nursing", "registered_nurse", None, 2.0),
                    ("1000",datetime(2024, 1, 2, 0, 0),"care_home_with_nursing", "senior_care_worker", None, 3.0),
                    ("1000",datetime(2024, 1, 2, 0, 0),"care_home_with_nursing", "senior_management", None, 4.0),
                    ("1000",datetime(2024, 1, 3, 0, 0),"care_home_with_nursing", "care_worker", 5.0, 6.0),
                    ("1000",datetime(2024, 1, 3, 0, 0),"care_home_with_nursing", "registered_nurse", 6.0, 8.0),
                    ("1000",datetime(2024, 1, 3, 0, 0),"care_home_with_nursing", "senior_care_worker", 7.0, 10.0),
                    ("1000",datetime(2024, 1, 3, 0, 0),"care_home_with_nursing", "senior_management", 8.0, 12.0),
                ],
            ...
            pytest.param(
                [
                    ...
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_with_nursing", "senior_care_worker", 3.0, 3.0),
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_with_nursing", "senior_management", 4.0, 4.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_with_nursing", "care_worker", 5.0, 6.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_with_nursing", "registered_nurse", 6.0, 8.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_with_nursing", "senior_care_worker", 7.0, 10.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_with_nursing", "senior_management", 8.0, 12.0),
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_only", "care_worker", 11.0, 11.0),
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_only", "registered_nurse", 12.0, 12.0),
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_only", "senior_care_worker", 13.0, 13.0),
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_only", "senior_management", 14.0, 14.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_only", "care_worker", 15.0, 26.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_only", "registered_nurse", 16.0, 28.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_only", "senior_care_worker", 17.0, 30.0),
                    ("1000", datetime(2024, 1, 2, 0, 0), "care_home_only", "senior_management", 18.0, 32.0),
                ],
            ...
            pytest.param(
                [
                    ...
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_with_nursing", "senior_care_worker", 3.0, 3.0),
                    ("1000", datetime(2024, 1, 1, 0, 0), "care_home_with_nursing", "senior_management", 4.0, 4.0),
                    ("1000", datetime(2024, 7, 5, 0, 0), "care_home_with_nursing", "care_worker", 5.0, 5.0),
                    ("1000", datetime(2024, 7, 5, 0, 0), "care_home_with_nursing", "registered_nurse", 6.0, 6.0),
                    ("1000", datetime(2024, 7, 5, 0, 0), "care_home_with_nursing", "senior_care_worker", 7.0, 7.0),
                    ("1000", datetime(2024, 7, 5, 0, 0), "care_home_with_nursing", "senior_management", 8.0, 8.0),
                ],
    ...
    def input_schema(self):
        return {
            ...
            IndCQC.cqc_location_import_date: pl.Datetime,
