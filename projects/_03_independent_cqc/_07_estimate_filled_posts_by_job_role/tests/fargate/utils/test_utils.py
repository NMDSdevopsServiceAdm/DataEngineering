...
class TestRollingSum:
    ...
    expected_primary_service_rolling_sum_when_one_primary_service_present_rows = [
        ("1000",1,"care_home_with_nursing", MainJobRoleLabels.care_worker, 1.0, 1.0),
        ("1000",1,"care_home_with_nursing", MainJobRoleLabels.registered_nurse, 2.0, 2.0),
        ("1000",1,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, 3.0, 3.0),
        ("1000",1,"care_home_with_nursing", MainJobRoleLabels.senior_management, 4.0, 4.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.care_worker, None, 1.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.registered_nurse, None, 2.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, None, 3.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.senior_management, None, 4.0),
        ("1000",3,"care_home_with_nursing", MainJobRoleLabels.care_worker, 5.0, 6.0),
        ("1000",3,"care_home_with_nursing", MainJobRoleLabels.registered_nurse, 6.0, 8.0),
        ("1000",3,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, 7.0, 10.0),
        ("1000",3,"care_home_with_nursing", MainJobRoleLabels.senior_management, 8.0, 12.0),
    ]
    ...
    expected_primary_service_rolling_sum_when_multiple_primary_services_present_rows = [
        ...
        ("1000",1,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, 3.0, 3.0),
        ("1000",1,"care_home_with_nursing", MainJobRoleLabels.senior_management, 4.0, 4.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.care_worker, 5.0, 6.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.registered_nurse, 6.0, 8.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, 7.0, 10.0),
        ("1000",2,"care_home_with_nursing", MainJobRoleLabels.senior_management, 8.0, 12.0),
        ("1000",1,"care_home_only", MainJobRoleLabels.care_worker, 11.0, 11.0),
        ("1000",1,"care_home_only", MainJobRoleLabels.registered_nurse, 12.0, 12.0),
        ("1000",1,"care_home_only", MainJobRoleLabels.senior_care_worker, 13.0, 13.0),
        ("1000",1,"care_home_only", MainJobRoleLabels.senior_management, 14.0, 14.0),
        ("1000",2,"care_home_only", MainJobRoleLabels.care_worker, 15.0, 26.0),
        ("1000",2,"care_home_only", MainJobRoleLabels.registered_nurse, 16.0, 28.0),
        ("1000",2,"care_home_only", MainJobRoleLabels.senior_care_worker, 17.0, 30.0),
        ("1000",2,"care_home_only", MainJobRoleLabels.senior_management, 18.0, 32.0),
    ]

    expected_primary_service_rolling_sum_when_days_not_within_rolling_window_rows = [
        ("1000",1704067200,"care_home_with_nursing", MainJobRoleLabels.care_worker, 1.0, 1.0),
        ("1000",1704067200,"care_home_with_nursing", MainJobRoleLabels.registered_nurse, 2.0, 2.0),
        ("1000",1704067200,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, 3.0, 3.0),
        ("1000",1704067200,"care_home_with_nursing", MainJobRoleLabels.senior_management, 4.0, 4.0),
        ("1000",1720137600,"care_home_with_nursing", MainJobRoleLabels.care_worker, 5.0, 5.0),
        ("1000",1720137600,"care_home_with_nursing", MainJobRoleLabels.registered_nurse, 6.0, 6.0),
        ("1000",1720137600,"care_home_with_nursing", MainJobRoleLabels.senior_care_worker, 7.0, 7.0),
        ("1000",1720137600,"care_home_with_nursing", MainJobRoleLabels.senior_management, 8.0, 8.0),
    ]
