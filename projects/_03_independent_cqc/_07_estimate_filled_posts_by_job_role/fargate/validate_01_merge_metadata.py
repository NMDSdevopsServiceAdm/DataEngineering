...
VALIDATION_COLS_TO_IMPORT = [
    ...
    IndCqcColumns.care_home_model,
    IndCqcColumns.imputed_pir_filled_posts_model,
    IndCqcColumns.imputed_posts_care_home_model,
    IndCqcColumns.imputed_posts_non_res_combined_model,
    IndCqcColumns.non_res_combined_model,
    IndCqcColumns.pir_people_directly_employed_dedup,
    IndCqcColumns.posts_rolling_average_model,
    IndCqcColumns.ct_care_home_total_employed_imputed,
    IndCqcColumns.ct_non_res_care_workers_employed_imputed,
]
