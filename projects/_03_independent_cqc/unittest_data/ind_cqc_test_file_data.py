...
class ModelPrimaryServiceRateOfChangeTrendlineData:
    ...
    primary_service_rate_of_change_trendline_rows = [
        ("1-001", 1704067200, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 3.0),
        ("1-001", 1704153600, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 2.8),
        ("1-001", 1704240000, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 3.4),
        ("1-001", 1704326400, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 3.2),
        ("1-002", 1704067200, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 2.0),
    ...
    expected_primary_service_rate_of_change_trendline_rows = [
        ...
        ("1-001", 1704153600, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 2.8, 1.03999),
        ("1-001", 1704240000, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 3.4, 1.16235),
        ("1-001", 1704326400, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 3.2, 1.26158),
        ("1-002", 1704067200, CareHome.care_home, 1.0, PrimaryServiceType.care_home_only, 2.0, 1.0),
