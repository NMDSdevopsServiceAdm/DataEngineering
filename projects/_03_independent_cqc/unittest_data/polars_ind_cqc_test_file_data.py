    ...
    reallocate_historical_filled_posts_by_job_role_test_cases = [
        ...
        EstimateFilledPostsByJobRoleEstimateUtilsTestCases(
            ...
            expected_data=[
                ...
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.data_analyst, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.data_governance_manager, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.it_and_digital_support, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.it_manager, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.it_service_desk_manager, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.software_developer, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.support_worker, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.activites_worker, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.care_worker, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.community_support_and_outreach, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.first_line_manager, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.senior_care_worker, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.other_managerial_staff, 1.0, 1.0),
                (1, "1-001", date(2023, 8, 1), MainJobRoleLabels.other_non_care_related_staff, 1.0, 1.0),
