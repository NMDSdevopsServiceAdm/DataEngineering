...
class ImputeJobRoleData:
    ...
    create_ascwds_job_role_rolling_ratio_test_cases = [
        ImputeJobRoleTestCase(
            ...
            data=[
                (1, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", 1.0, 4.0, 0.4),
                (2, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", 2.0, 6.0, 0.6),
                (3, "2000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", 3.0, 4.0, 0.4),
                (4, "2000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", 4.0, 6.0, 0.6),
                (5, "1000", date(2024, 1, 2), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", None, 4.0, 0.4),
                (6, "1000", date(2024, 1, 2), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", None, 6.0, 0.6),
                (7, "2000", date(2024, 1, 2), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", None, 4.0, 0.4),
                (8, "2000", date(2024, 1, 2), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", None, 6.0, 0.6),
                (9, "1000", date(2024, 1, 3), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", 5.0, 16.0, 0.44444),
                (10, "1000", date(2024, 1, 3), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", 6.0, 20.0, 0.55556),
                (11, "2000", date(2024, 1, 3), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", 7.0, 16.0, 0.44444),
                (12, "2000", date(2024, 1, 3), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", 8.0, 20.0, 0.55556),
            ],
        ),
        ImputeJobRoleTestCase(
            id="when_multiple_primary_services_present",
            data=[
                (1, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", 1.0, 1.0, 0.33333),
                (2, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", 2.0, 2.0, 0.66667),
                (3, "2000", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 8.0, "COH 1 to 9", 3.0, 3.0, 0.428571),
                (4, "2000", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 8.0, "COH 1 to 9", 4.0, 4.0, 0.571429),
                (5, "1000", date(2024, 1, 2), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", None, 1.0, 0.333333),
                (6, "1000", date(2024, 1, 2), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", None, 2.0, 0.666667),
                (7, "2000", date(2024, 1, 2), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 8.0, "COH 1 to 9", None, 3.0, 0.428571),
                (8, "2000", date(2024, 1, 2), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 8.0, "COH 1 to 9", None, 4.0, 0.571429),
                (9, "1000", date(2024, 1, 3), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 4.0, "CHWN 1 to 19", 5.0, 6.0, 0.428571),
                (10, "1000", date(2024, 1, 3), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 4.0, "CHWN 1 to 19", 6.0, 8.0, 0.571429),
                (11, "2000", date(2024, 1, 3), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 8.0, "COH 1 to 9", 7.0, 10.0, 0.454545 ),
                (12, "2000", date(2024, 1, 3), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 8.0, "COH 1 to 9", 8.0, 12.0, 0.545455),
            ],
        ),
        ImputeJobRoleTestCase(
            id="when_days_not_within_rolling_window",
            data=[
                (1, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 8.0, "CHWN 1 to 19", 1.0, 1.0, 0.1),
                (2, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 8.0, "CHWN 1 to 19", 2.0, 2.0, 0.2),
                (3, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.senior_care_worker, 8.0, "CHWN 1 to 19", 3.0, 3.0, 0.3),
                (4, "1000", date(2024, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.senior_management, 8.0, "CHWN 1 to 19", 4.0, 4.0, 0.4),
                (5, "1000", date(2024, 7, 5), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 8.0, "CHWN 1 to 19", 5.0, 5.0, 0.192308),
                (6, "1000", date(2024, 7, 5), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 8.0, "CHWN 1 to 19", 6.0, 6.0, 0.230769),
                (7, "1000", date(2024, 7, 5), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.senior_care_worker, 8.0, "CHWN 1 to 19", 7.0, 7.0, 0.269231),
                (8, "1000", date(2024, 7, 5), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.senior_management, 8.0, "CHWN 1 to 19", 8.0, 8.0, 0.307692),
            ],
        ),
    ]  # fmt: skip
