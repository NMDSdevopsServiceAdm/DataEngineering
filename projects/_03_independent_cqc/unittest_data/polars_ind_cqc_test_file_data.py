...
class InterpolationData:
    interpolation_test_cases = [
        ModelInterpolationTestCase(
            id="single_location_interpolation_when_method_is_trend",
            data=[
                ("1-001", date(2023, 1, 1), 1672531200, None, None, None),
                ("1-001", date(2023, 2, 1), 1675209600, None, None, None),
                ("1-001", date(2023, 3, 1), 1677628800, 40.0, None, None),
                ("1-001", date(2023, 4, 1), 1680307200, None, 42.0, 38.01912568306011),
                ("1-001", date(2023, 5, 1), 1682899200, None, 44.0, 36.166666666666664),
                ("1-001", date(2023, 6, 1), 1685577600, None, 46.0, 34.185792349726775),
                ("1-001", date(2023, 7, 1), 1688169600, None, 48.0, 32.333333333333336),
                ("1-001", date(2023, 8, 1), 1690848000, None, 50.0, 30.352459016393443),
                ("1-001", date(2023, 9, 1), 1693526400, None, 52.0, 28.371584699453553),
                ("1-001", date(2023, 10, 1), 1696118400, None, 54.0, 26.51912568306011),
                ("1-001", date(2023, 11, 1), 1698796800, None, 56.0, 24.53825136612022),
                ("1-001", date(2023, 12, 1), 1701388800, None, 58.0, 22.685792349726782),
                ("1-001", date(2024, 1, 1), 1704067200, None, 56.0, 16.704918032786885),
                ("1-001", date(2024, 2, 1), 1706745600, None, 54.0, 10.724043715846996),
                ("1-001", date(2024, 3, 1), 1709251200, 5.0, 52.0, None),
                ("1-001", date(2024, 4, 1), 1711929600, None, 5.31, 10.198852459016393),
                ("1-001", date(2024, 5, 1), 1714521600, 15.0, 5.38, None),
                ("1-001", date(2024, 6, 1), 1717200000, None, 13.93, None),
            ],
            method="trend",
        ),
        ModelInterpolationTestCase(
            id="multiple_locations_interpolation_when_method_is_trend",
            data=[
                ("1-001", date(2023, 1, 1), 1672531200, None, None, None),
                ("1-001", date(2023, 3, 1), 1677628800, 40.0, None, None),
                ("1-001", date(2023, 6, 1), 1685577600, None, 46.0, 34.185792),
                ("1-001", date(2024, 3, 1), 1709251200, 5.0, 52.0, None),
                ("1-002", date(2023, 1, 1), 1672531200, None, None, None),
                ("1-002", date(2023, 2, 1), 1675209600, None, None, None),
                ("1-002", date(2023, 5, 1), 1682899200, 20.0, None, None),
                ("1-002", date(2023, 6, 1), 1685577600, None, 25.0, None),
                ("1-002", date(2023, 7, 1), 1688169600, None, 30.0, None),
                ("1-003", date(2023, 1, 1), 1672531200, None, None, None),
                ("1-003", date(2023, 2, 1), 1675209600, 100.0, None, None),
                ("1-003", date(2023, 3, 1), 1677628800, None, 110.0, None),
                ("1-004", date(2023, 1, 1), 1672531200, None, None, None),
                ("1-004", date(2023, 2, 1), 1675209600, None, None, None),
            ],
            method="trend",
        ),
        ModelInterpolationTestCase(
            id="single_location_interpolation_when_method_is_straight",
            data=[
                ("1-001", date(2023, 1, 1), 1672531200, None, None, None),
                ("1-001", date(2023, 2, 1), 1675209600, None, None, None),
                ("1-001", date(2023, 3, 1), 1677628800, 40.0, None, None),
                ("1-001", date(2023, 4, 1), 1680307200, None, 42.0, 37.03551912568306),
                ("1-001", date(2023, 5, 1), 1682899200, None, 44.0, 34.166666666666664),
                ("1-001", date(2023, 6, 1), 1685577600, None, 46.0, 31.202185792349727),
                ("1-001", date(2023, 7, 1), 1688169600, None, 48.0, 28.333333333333336),
                ("1-001", date(2023, 8, 1), 1690848000, None, 50.0, 25.368852459016395),
                ("1-001", date(2023, 9, 1), 1693526400, None, 52.0, 22.404371584699454),
                ("1-001", date(2023, 10, 1), 1696118400, None, 54.0, 19.53551912568306),
                ("1-001", date(2023, 11, 1), 1698796800, None, 56.0, 16.571038251366122),
                ("1-001", date(2023, 12, 1), 1701388800, None, 58.0, 13.702185792349727),
                ("1-001", date(2024, 1, 1), 1704067200, None, 56.0, 10.737704918032787),
                ("1-001", date(2024, 2, 1), 1706745600, None, 54.0, 7.7732240437158495),
                ("1-001", date(2024, 3, 1), 1709251200, 5.0, 52.0, None),
                ("1-001", date(2024, 4, 1), 1711929600, None, 5.31, 10.081967213114755),
                ("1-001", date(2024, 5, 1), 1714521600, 15.0, 5.38, None),
                ("1-001", date(2024, 6, 1), 1717200000, None, 13.93, None),
            ],
            method="straight",
    ...
    calculate_time_between_submissions_test_cases = [
        ...
        ModelInterpolationTestCase(
            ...
            data=[
                ("1-001", date(2024, 1, 1), 1000000000, 5.0, None, None),
                ("1-001", date(2024, 2, 1), 1000000100, None, None, None),
                ("1-002", date(2024, 1, 5), 1000000200, 3.0, None, None),
                ("1-002", date(2024, 2, 5), 1000000300, None, None, None),
                ("1-003", date(2024, 3, 1), 1000000400, 8.0, None, None),
                ("1-003", date(2024, 4, 1), 1000000500, None, None, None),
            ],
        ),
        ModelInterpolationTestCase(
            id="two_locations_interleaved",
            data=[
                ("1-001", date(2024, 1, 1), 1000000000, 10.0, None, None),
                ("1-002", date(2024, 1, 2), 1000000100, 10.0, None, None),
                ("1-001", date(2024, 2, 1), 1000000200, None, 400, 0.5),
                ("1-002", date(2024, 2, 2), 1000000300, None, 400, 0.5),
                ("1-001", date(2024, 3, 1), 1000000400, 7.0, None, None),
                ("1-002", date(2024, 3, 2), 1000000500, 7.0, None, None),
            ],
        ),
    ]  # fmt: skip
