...
class EstimateFilledPostsByJobRoleCleanUtilsData:
    filter_when_job_group_ratio_outside_percentile_bounds_test_cases = [
        EstimateFilledPostsByJobRoleCleanUtilsTestCase(
            id="when_job_role_group_ratios_has_upper_bound",
            test_data=[
        ...
        EstimateFilledPostsByJobRoleCleanUtilsTestCase(
            id="when_job_role_group_ratios_has_lower_bound",
            test_data=[
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20, 20),
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 5, 5),
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_manager, 10, 10),
        ...
        EstimateFilledPostsByJobRoleCleanUtilsTestCase(
            id="when_ratio_bounds_are_not_defined",
            test_data=[
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20, 20),
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 5, 5),
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_manager, 10, 10),
        ...
        EstimateFilledPostsByJobRoleCleanUtilsTestCase(
            ...
            test_data=[
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20, 20),
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 5, 5),
                ("loc1", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 10, 10),
                ("loc1", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 1, 1),
                ("loc2", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 15, 15),
                ("loc2", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 10, 10),
                ("loc2", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 2, 2),
                ("loc2", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 2, 2),
                ("loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 10, 10),
                ("loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3, 3),
                ("loc3", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20, 20),
                ("loc3", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3, 3),
            ],
            expected_data=[
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20, 20),
                ("loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 5, 5),
                ("loc1", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 10, None),
                ("loc1", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 1, None),
                ("loc2", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 15, None),
                ("loc2", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 10, None),
                ("loc2", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 2, 2),
                ("loc2", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 2, 2),
                ("loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 10, None),
                ("loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3, None),
                ("loc3", date(2024, 2, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20, None),
