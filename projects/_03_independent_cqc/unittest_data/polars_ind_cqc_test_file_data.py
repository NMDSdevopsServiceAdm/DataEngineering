...
class EstimateFilledPostsByJobRoleEstimateUtilsData:
    ...
    reallocate_historical_filled_posts_by_job_role_test_cases = [
        ...
        EstimateFilledPostsByJobRoleEstimateUtilsTestCases(
            ...
            expected_data=[
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.senior_management, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.middle_management, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.registered_manager, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.social_worker, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.employment_support, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.advocacy, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.occupational_therapist, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.registered_nurse, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.allied_health_professional, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.technician, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.other_care_role, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.admin_staff, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.ancillary_staff, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.safeguarding_officer, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.occupational_therapist_assistant, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.registered_nursing_associate, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.nursing_assistant, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.assessment_officer, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.care_coordinator, 1.0, 1.0),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.childrens_roles, 1.0, 1.0),
            ], # fmt: skip
        ),
        EstimateFilledPostsByJobRoleEstimateUtilsTestCases(
            ...
            expected_data=[
                ...
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.team_leader, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.data_analyst, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.data_governance_manager, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.it_and_digital_support, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.it_manager, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.it_service_desk_manager, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.software_developer, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.support_worker, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.activites_worker, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.care_worker, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.community_support_and_outreach, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.first_line_manager, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.senior_care_worker, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.other_managerial_staff, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.other_non_care_related_staff, 1.0, 1.0),
                (1, "1-001", date(2024, 6, 1), MainJobRoleLabels.supervisor, 1.0, 1.0),
            ], # fmt: skip
        ),
    ]
