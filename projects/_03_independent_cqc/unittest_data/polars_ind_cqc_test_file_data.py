    ...
    interpolation_test_cases = [
        ModelInterpolationTestCase(
            ...
            data=[
                ...
                ("1-001", date(2023, 2, 1), None, None, None),
                ("1-001", date(2023, 3, 1), 40.0, None, None),
                ("1-001", date(2023, 4, 1), None, 42.0, 38.01912568306011),
                ("1-001", date(2023, 5, 1), None, 44.0, 36.166666666666664),
                ("1-001", date(2023, 6, 1), None, 46.0, 34.185792349726775),
                ("1-001", date(2023, 7, 1), None, 48.0, 32.333333333333336),
                ("1-001", date(2023, 8, 1), None, 50.0, 30.352459016393443),
                ("1-001", date(2023, 9, 1), None, 52.0, 28.371584699453553),
                ("1-001", date(2023, 10, 1), None, 54.0, 26.51912568306011),
                ("1-001", date(2023, 11, 1), None, 56.0, 24.53825136612022),
                ("1-001", date(2023, 12, 1), None, 58.0, 22.685792349726782),
                ("1-001", date(2024, 1, 1), None, 56.0, 16.704918032786885),
                ("1-001", date(2024, 2, 1), None, 54.0, 10.724043715846996),
                ("1-001", date(2024, 3, 1), 5.0, 52.0, None),
                ("1-001", date(2024, 4, 1), None, 5.31, 10.198852459016393),
                ("1-001", date(2024, 5, 1), 15.0, 5.38, None),
                ("1-001", date(2024, 6, 1), None, 13.93, None),
            ],
            method="trend",
        ),
        ModelInterpolationTestCase(
            ...
            data=[
                ...
                ("1-001", date(2024, 3, 1), 5.0, 52.0, None),
                ("1-002", date(2023, 1, 1), None, None, None),
                ("1-002", date(2023, 2, 1), None, None, None),
                ("1-002", date(2023, 5, 1), 20.0, None, None),
                ("1-002", date(2023, 6, 1), None, 25.0, None),
                ("1-002", date(2023, 7, 1), None, 30.0, None),
                ("1-003", date(2023, 1, 1), None, None, None),
                ("1-003", date(2023, 2, 1), 100.0, None, None),
                ("1-003", date(2023, 3, 1), None, 110.0, None),
                ("1-004", date(2023, 1, 1), None, None, None),
                ("1-004", date(2023, 2, 1), None, None, None),
            ],
            method="trend",
        ),
        ModelInterpolationTestCase(
            ...
            data=[
                ...
                ("1-001", date(2023, 2, 1), None, None, None),
                ("1-001", date(2023, 3, 1), 40.0, None, None),
                ("1-001", date(2023, 4, 1), None, 42.0, 37.03551912568306),
                ("1-001", date(2023, 5, 1), None, 44.0, 34.166666666666664),
                ("1-001", date(2023, 6, 1), None, 46.0, 31.202185792349727),
                ("1-001", date(2023, 7, 1), None, 48.0, 28.333333333333336),
                ("1-001", date(2023, 8, 1), None, 50.0, 25.368852459016395),
                ("1-001", date(2023, 9, 1), None, 52.0, 22.404371584699454),
                ("1-001", date(2023, 10, 1), None, 54.0, 19.53551912568306),
                ("1-001", date(2023, 11, 1), None, 56.0, 16.571038251366122),
                ("1-001", date(2023, 12, 1), None, 58.0, 13.702185792349727),
                ("1-001", date(2024, 1, 1), None, 56.0, 10.737704918032787),
                ("1-001", date(2024, 2, 1), None, 54.0, 7.7732240437158495),
                ("1-001", date(2024, 3, 1), 5.0, 52.0, None),
                ("1-001", date(2024, 4, 1), None, 5.31, 10.081967213114755),
                ("1-001", date(2024, 5, 1), 15.0, 5.38, None),
                ("1-001", date(2024, 6, 1), None, 13.93, None),
            ],
            method="straight",
