    ...
    filter_when_job_group_ratio_outside_percentile_bounds_test_cases = [
        ...
        EstimateFilledPostsByJobRoleCleanUtilsTestCase(
            ...
            test_data=[
                ...
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 2),
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 2),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 10),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 3),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 20),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 3),
            ],
            expected_data=[
                (1, "loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20),
                (1, "loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 5),
                ...
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, None),
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, None),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, 10),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, 3),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.care_worker, None),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_with_nursing, MainJobRoleLabels.registered_nurse, None),
            ],
            upper_bound=0.8,
            lower_bound=0.2,
        ),
        EstimateFilledPostsByJobRoleCleanUtilsTestCase(
            ...
            test_data=[
                ...
                (3, "loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 15),
                (3, "loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 10),
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 2),
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 2),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 10),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3),
            ],
            expected_data=[
                (1, "loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20),
                (1, "loc1", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 5),
                ...
                (3, "loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 15),
                (3, "loc3", date(2024, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 10),
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, None),
                (4, "loc1", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, None),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 10),
                (5, "loc2", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.care_worker, 20),
                (6, "loc3", date(2025, 1, 1), PrimaryServiceType.care_home_only, MainJobRoleLabels.registered_nurse, 3),
