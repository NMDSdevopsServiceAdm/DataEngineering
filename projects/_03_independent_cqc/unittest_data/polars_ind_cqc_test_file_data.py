...
class ModelExtrapolation:
    extrapolation_when_nominal_test_cases = [
        ...
        ExtrapolationTestCase(
            ...
            data=[
                ("1-002", date(2026, 1, 1), None, 10.0, None, -50.0),
                ("1-002", date(2026, 2, 1), 10.0, 20.0, None, None),
                ("1-002", date(2026, 3, 1), None, 30.0, 20.0, None),
                ("1-002", date(2026, 4, 1), 20.0, 80.0, 70.0, None),
                ("1-002", date(2026, 5, 1), None, 100.0, 90.0, 90.0),
            ],
        ),
        ExtrapolationTestCase(
    ...
    extrapolation_when_ratio_test_cases = [
        ...
        ExtrapolationTestCase(
            id="when_earlier_and_later_and_intermediate_data_points_are_missing",
            data=[
                ("1-002", date(2026, 1, 1), None, 10.0, None, 2.5),
                ("1-002", date(2026, 2, 1), 10.0, 20.0, None, None),
                ("1-002", date(2026, 3, 1), None, 30.0, 15.0, None),
                ("1-002", date(2026, 4, 1), 20.0, 80.0, 40.0, None),
                ("1-002", date(2026, 5, 1), None, 100.0, 50.0, 50.0),
            ],
        ),
        ExtrapolationTestCase(
            id="when_more_than_one_location_needs_extrapolating",
