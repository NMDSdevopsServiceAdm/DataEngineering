...
class FeaturesEngineeringUtilsData:
    ...
    select_and_filter_features_rows = [
        ("1-001", date(2025, 1, 1), "Y", 10, 5, 1, 100.0, 1, 10),
        ("1-002", date(2025, 1, 2), "N", None, 10, 1, 150.0, 1, 20),
        ("1-003", date(2025, 1, 3), "Y", 30, None, 0, 200.0, 1, 30),
    ]
    expected_select_and_filter_features_rows = [
        ("1-001", date(2025, 1, 1), 1, 10, 100.0, 10, 5, 1),
    ]
