    ...
    reallocate_historical_filled_posts_by_job_role_test_cases = [
        ...
        EstimateFilledPostsByJobRoleEstimateUtilsTestCases(
            ...
            expected_data=[
                ...
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.first_line_manager, 1.0, 1.6039),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.senior_care_worker, 1.0, 1.4977),
                (1,"1-001", date(2024, 3, 31), MainJobRoleLabels.supervisor, 1.0, 1.3455),
            ], # fmt: skip
        ),
        EstimateFilledPostsByJobRoleEstimateUtilsTestCases(
