...
import projects._03_independent_cqc._01_filled_posts._06_job_role_estimates.fargate.validate_02_clean as job
...
PATCH_PATH = "projects._03_independent_cqc._01_filled_posts._06_job_role_estimates.fargate.validate_02_clean"
...
class ValidateJobRoleEstimatesTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.compare_df = self.source_df.select(
            [IndCqcColumns.location_id, IndCqcColumns.ascwds_job_role_counts]
        )
        ...
        mock_read_parquet.assert_has_calls(
            [
                ...
                call(
                    ...
                    selected_columns=job.IND_CQC_MERGE_COLS_TO_IMPORT,
                ),
            ]
        )
