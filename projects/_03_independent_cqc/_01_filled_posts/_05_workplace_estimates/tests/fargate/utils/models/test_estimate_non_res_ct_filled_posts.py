...
import projects._03_independent_cqc._01_filled_posts._05_workplace_estimates.fargate.utils.models.estimate_non_res_ct_filled_posts as job
...
PATCH_PATH: str = (
    "projects._03_independent_cqc._01_filled_posts._05_workplace_estimates.fargate.utils.models.estimate_non_res_ct_filled_posts"
)
...
class CalculateCareWorkerRatioTest(EstimateNonResCapacityTrackerFilledPostsTests):
    ...
    def test_function_returns_expected_value(self):
        ...
        expected_lf = pl.LazyFrame(data=[0.5], schema={returned_ratio: pl.Float32})
        returned_ratio = (
