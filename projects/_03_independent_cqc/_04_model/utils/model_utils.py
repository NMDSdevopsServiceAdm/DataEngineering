...
def calculate_metrics(
    y_known: np.ndarray, y_predicted: np.ndarray, number_of_beds: np.ndarray
) -> dict:
    """
    ...
    Args:
        ...
        number_of_beds (np.ndarray): Number of beds at each datapoint.
    ...
    abs_diff = np.absolute((y_known * number_of_beds) - (y_predicted * number_of_beds))
