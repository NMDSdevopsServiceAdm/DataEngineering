...
def calculate_proportion_of_time_between_submissions(
    ...
    """
    get_previous_submission_time_expr = (
    ...
    lf = lf.sort([IndCqc.location_id, IndCqc.unix_time]).with_columns(
        get_previous_submission_time_expr,
        get_next_submission_time_expr,
    )
    ...
    lf = lf.with_columns(
        ...
        .then(
            pl.col(IndCqc.next_submission_time) - pl.col(IndCqc.previous_submission_time)
        )
