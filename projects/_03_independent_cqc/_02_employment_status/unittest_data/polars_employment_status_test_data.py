...
class TestCleanUtilsData:
    join_ratio_too_low_flags_test_cases = [
        CleanUtilsTestCase(
            ...
            expected_data={
                ...
                EmpStatus.agency_count_dedup: [0, 0],
                EmpStatus.other_count_dedup: [9, 10],
                # location ratio (1/20 = 0.05) is above the location threshold
                # (0.01), even though it's at the org threshold (0.05).
                LOCATION_RATIO_TOO_LOW_COLUMN: [False, False],
                ORG_RATIO_TOO_LOW_COLUMN: [True, True],
            },
        ),
        CleanUtilsTestCase(
            id="does_not_flag_ratio_above_either_threshold",
            input_data={
            ...
            expected_data={
                ...
                EmpStatus.agency_count_dedup: [0],
                EmpStatus.other_count_dedup: [0],
                LOCATION_RATIO_TOO_LOW_COLUMN: [False],
                ORG_RATIO_TOO_LOW_COLUMN: [False],
            },
        ),
        CleanUtilsTestCase(
            id="org_flag_is_false_for_null_organisation_id_even_when_location_flag_is_true",
            input_data={
                # Without the null-org guard, .over()/group_by would pool
                # these unrelated locations into one fake org.
            ...
            expected_data={
                ...
                EmpStatus.agency_count_dedup: [0, 0],
                EmpStatus.other_count_dedup: [20, 20],
                LOCATION_RATIO_TOO_LOW_COLUMN: [True, True],
                ORG_RATIO_TOO_LOW_COLUMN: [False, False],
            },
        ),
        CleanUtilsTestCase(
            id="location_flag_can_differ_within_an_org_that_is_flagged_overall",
            input_data={
            ...
            expected_data={
                ...
                EmpStatus.agency_count_dedup: [0, 0],
                EmpStatus.other_count_dedup: [9, 10],
                # loc1's own ratio (1/10=0.1) is above 0.01; loc2's own ratio
                # (0/10=0) is at/below it - but combined org ratio (1/20=0.05)
                # flags both under the org rule.
                LOCATION_RATIO_TOO_LOW_COLUMN: [False, True],
                ORG_RATIO_TOO_LOW_COLUMN: [True, True],
            },
        ),
        CleanUtilsTestCase(
            id="does_not_pool_different_import_dates_into_one_group",
            input_data={
            ...
            expected_data={
                ...
                EmpStatus.agency_count_dedup: [0, 0],
                EmpStatus.other_count_dedup: [20, 5],
                LOCATION_RATIO_TOO_LOW_COLUMN: [True, False],
                ORG_RATIO_TOO_LOW_COLUMN: [True, False],
            },
        ),
        CleanUtilsTestCase(
            id="sums_across_job_roles_and_locations_before_deciding_either_total",
            input_data={
                IndCQC.organisation_id: ["org_multi"] * 5,
                IndCQC.location_id: [
                    "loc_low_ratio",
                    "loc_low_ratio",
                    "loc_high_ratio",
            ...
            expected_data={
                ...
                EmpStatus.agency_count_dedup: [0, 0, 0, 0, 0],
                EmpStatus.other_count_dedup: [10, 10, 9, 10, 5],
                # org staff = 10+10+10+10+5 = 45, perm+temp = 1 -> 1/45 <= 0.05
                LOCATION_RATIO_TOO_LOW_COLUMN: [True, True, False, False, False],
                ORG_RATIO_TOO_LOW_COLUMN: [True, True, True, True, True],
            },
        ),
    ]
    ...
    null_counts_for_low_org_ratio_test_cases = [
        CleanUtilsTestCase(
            id="nulls_clean_counts_when_org_ratio_too_low_flag_is_true",
            input_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [1],
                EmpStatus.temporary_count_dedup: [0],
                EmpStatus.bank_or_pool_count_dedup: [0],
                EmpStatus.agency_count_dedup: [0],
                EmpStatus.other_count_dedup: [9],
                ORG_RATIO_TOO_LOW_COLUMN: [True],
            },
            expected_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [1],
        ...
        CleanUtilsTestCase(
            id="keeps_clean_counts_when_org_ratio_too_low_flag_is_false",
            input_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [5],
                EmpStatus.temporary_count_dedup: [5],
        ...
        CleanUtilsTestCase(
            id="flags_missing_data_for_a_null_dedup_row_regardless_of_org_flag",
            input_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [None],
                EmpStatus.temporary_count_dedup: [None],
                EmpStatus.bank_or_pool_count_dedup: [None],
                EmpStatus.agency_count_dedup: [None],
                EmpStatus.other_count_dedup: [None],
                ORG_RATIO_TOO_LOW_COLUMN: [False],
            },
            expected_data={
                IndCQC.location_id: ["loc1"],
                ...
                EmpStatus.agency_count_clean: [None],
                EmpStatus.other_count_clean: [None],
                EmpStatus.filtering_rule: [EmploymentStatusFilteringRule.missing_data],
            },
        ),
    ]
    ...
    null_counts_for_low_location_ratio_test_cases = [
        CleanUtilsTestCase(
            id="nulls_clean_counts_further_when_location_ratio_too_low_flag_is_true",
            input_data={
                IndCQC.location_id: ["loc1"],
                ...
                EmpStatus.permanent_count_clean: [0],
                EmpStatus.temporary_count_clean: [0],
                EmpStatus.bank_or_pool_count_clean: [0],
                EmpStatus.agency_count_clean: [0],
                EmpStatus.other_count_clean: [20],
                EmpStatus.filtering_rule: [EmploymentStatusFilteringRule.populated],
                LOCATION_RATIO_TOO_LOW_COLUMN: [True],
            },
            expected_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [0],
        ...
        CleanUtilsTestCase(
            id="keeps_clean_counts_when_location_ratio_too_low_flag_is_false",
            input_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [5],
                EmpStatus.temporary_count_dedup: [5],
        ...
        CleanUtilsTestCase(
            id="keeps_org_level_reason_when_location_flag_is_also_true",
            input_data={
                IndCQC.location_id: ["loc1"],
                EmpStatus.permanent_count_dedup: [0],
                EmpStatus.temporary_count_dedup: [0],
