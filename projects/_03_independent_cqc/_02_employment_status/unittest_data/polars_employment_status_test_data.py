    ...
    null_counts_for_low_location_ratio_test_cases = [
        CleanUtilsTestCase(
            ...
            input_data={
                ...
                EmpStatus.other_count_dedup: [0, 0, 0, 0, 0],
            ...
            expected_data={
                ...
                EmpStatus.permanent_percentage: [None, None, 0.5, 0.5, 0.5],
                EmpStatus.temporary_percentage: [None, None, 0.5, 0.5, 0.5],
                EmpStatus.bank_or_pool_percentage: [None, None, 0.5, 0.5, 0.5],
                EmpStatus.agency_percentage: [None, None, 0.5, 0.5, 0.5],
                EmpStatus.other_percentage: [None, None, 0.5, 0.5, 0.5],
    ...
    null_counts_for_low_org_ratio_test_cases = [
        CleanUtilsTestCase(
            ...
            expected_data={
                ...
                EmpStatus.permanent_percentage: [None, None],
                EmpStatus.temporary_percentage: [None, None],
                EmpStatus.bank_or_pool_percentage: [None, None],
                EmpStatus.agency_percentage: [None, None],
                EmpStatus.other_percentage: [None, None],
                EmpStatus.filtering_rule: [
                    EmploymentStatusFilteringRule.org_level_low_permanent_temporary_ratio
                ]
                * 2,
        ...
        CleanUtilsTestCase(
            ...
            input_data={
                ...
                EmpStatus.other_count_dedup: [0, 0, 0, 0],
        ...
        CleanUtilsTestCase(
            ...
            expected_data={
                ...
                EmpStatus.permanent_percentage: [None, 0.5],
                EmpStatus.temporary_percentage: [None, 0.5],
                EmpStatus.bank_or_pool_percentage: [None, 0.5],
                EmpStatus.agency_percentage: [None, 0.5],
                EmpStatus.other_percentage: [None, 0.5],
                EmpStatus.filtering_rule: [
                    EmploymentStatusFilteringRule.org_level_low_permanent_temporary_ratio,
                    EmploymentStatusFilteringRule.populated,
                ],
