...
DIAGNOSTICS_JOB_NAME = "empstat_spike_l2_red_n20"
...
class TestMain:
    ...
    def test_passes_twenty_category_mapping_to_imputation(
        ...
        expected_columns = (
            job.iUtils.EMPLOYMENT_STATUS_PERCENTAGE_COLUMNS | DUMMY_MAPPING
        )
        ...
        add_rolling_mock.assert_called_once_with(
            ...
            percentage_columns=expected_columns,
        )
        add_imputed_mock.assert_called_once_with(
            add_rolling_mock.return_value, percentage_columns=expected_columns
        )
