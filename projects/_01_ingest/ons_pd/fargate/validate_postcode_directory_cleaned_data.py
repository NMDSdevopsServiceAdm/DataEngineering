...
COMPLETE_COLUMNS = [
    ...
    ONSClean.contemporary_latitude,
    ONSClean.contemporary_longitude,
    ONSClean.contemporary_imd_score,
    ...
    ONSClean.current_latitude,
    ONSClean.current_longitude,
    ONSClean.current_imd_score,
    ONSClean.current_lsoa11,
    ONSClean.current_msoa11,
    ONSClean.current_rural_urban_ind_11,
    ONSClean.current_rural_urban_ind_21,
    ONSClean.current_lsoa21,
    ONSClean.current_msoa21,
    ONSClean.current_constituency,
]
