    ...
    return pl.DataFrame(
        {
            ...
            ONSClean.contemporary_sub_icb: ["Sub ICB 1"] * len(postcodes),
            ONSClean.contemporary_icb: ["ICB 1"] * len(postcodes),
            ONSClean.contemporary_icb_region: region,
            ONSClean.contemporary_latitude: [51.5] * len(postcodes),
            ONSClean.contemporary_longitude: [-0.1] * len(postcodes),
            ONSClean.contemporary_imd_score: [50.0] * len(postcodes),
            ONSClean.contemporary_lsoa11: ["E01000001"] * len(postcodes),
            ONSClean.contemporary_msoa11: ["E02000001"] * len(postcodes),
            ONSClean.contemporary_rural_urban_ind_11: ["Urban major conurbation"]
            * len(postcodes),
            ONSClean.contemporary_lsoa21: ["E01000001"] * len(postcodes),
            ONSClean.contemporary_msoa21: ["E02000001"] * len(postcodes),
            ONSClean.contemporary_constituency: ["Barking and Dagenham"]
            * len(postcodes),
            ...
            ONSClean.current_latitude: [51.5] * len(postcodes),
            ONSClean.current_longitude: [-0.1] * len(postcodes),
            ONSClean.current_imd_score: [50.0] * len(postcodes),
            ONSClean.current_lsoa11: ["E01000001"] * len(postcodes),
            ONSClean.current_msoa11: ["E02000001"] * len(postcodes),
            ...
            * len(postcodes),
            ...
            ONSClean.current_constituency: ["Barking and Dagenham"] * len(postcodes),
        }
    )
