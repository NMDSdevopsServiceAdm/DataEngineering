...
columns = {
    AWKClean.location_id: "String",
    AWKClean.establishment_id: "String",
    AWKClean.worker_id: "String",
    AWKClean.main_job_role_id: "String",
    AWKClean.ascwds_worker_import_date: "Date",
    AWKClean.main_job_role_clean: str(CategoricalColumnTypes.MainJobRoleIdEnumType),
    AWKClean.main_job_role_clean_labelled: str(
...
def main(bucket_name: str, source_path: str, reports_path: str) -> None:
    ...
    validation = (
        ...
        # index columns
        .rows_distinct([AWKClean.worker_id, AWKClean.ascwds_worker_import_date])
        # complete columns
        .col_vals_not_null(
            columns=[
