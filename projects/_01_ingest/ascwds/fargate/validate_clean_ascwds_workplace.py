...
def main(bucket_name: str, source_path: str, reports_path: str) -> None:
    ...
    validation = (
        ...
        .col_vals_in_set(
            ...
            CatValues.establishment_type_column_values.categorical_values,
        )
        .col_vals_in_set(
        ...
        .col_vals_in_set(
            ...
            CatValues.main_service_id_column_values.categorical_values,
        )
        .col_vals_in_set(
            ASCWPClean.registration_type,
            CatValues.registration_type_column_values.categorical_values,
        )
        # distinct values
        .specially(
