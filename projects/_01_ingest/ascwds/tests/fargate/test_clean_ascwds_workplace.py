...
class TestMain:
    ...
    @patch(f"{PATCH_PATH}.wUtils.recheck_duplicate_establishments")
    ...
    def test_main_runs(
        ...
        recheck_duplicate_establishments_mock: Mock,
