...
# Ingest-CQC-PIR against the polars/pointblank bump. Remove before merging.
import sys
...
def main(source: str, destination_prefix: str) -> None:
    ...
    # PIR CSVs are Excel-exported and frequently not valid UTF-8; utf8-lossy avoids failing on that.
