...
import projects._01_ingest.cqc_pir.fargate.validate_clean_cqc_pir_data as job
from utils.column_names.cleaned_data_files.cqc_pir_cleaned import (
    CqcPIRCleanedColumns as PIRClean,
)

PATCH_PATH = "projects._01_ingest.cqc_pir.fargate.validate_clean_cqc_pir_data"


class TestMain:
    source_df = pl.DataFrame(
        {
            PIRClean.cqc_pir_import_date: ["2025-01-01"],
            PIRClean.location_id: ["1-000000001"],
