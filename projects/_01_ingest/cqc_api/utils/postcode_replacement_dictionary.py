...
class ManualPostcodeCorrections:
    ...
    postcode_corrections_dict = {
        "CF105AS": "BS354QD",  # Welsh postcode. Cardiff. Setting to Bristol temporarily to make job succeed.
        "NP206QS": "BS354QD",  # Welsh postcode. Newport. Setting to Bristol temporarily to make job succeed.
