...
import projects._01_ingest.cqc_api.fargate.validate_cqc_providers_4_full_clean as job

PATCH_PATH = "projects._01_ingest.cqc_api.fargate.validate_cqc_providers_4_full_clean"


class ValidateProvidersFlattenTests(unittest.TestCase):
    def setUp(self) -> None:
        self.validate_df = pl.DataFrame(
            [
                ("1-00001", "20250101", date(2025, 1, 1), "Name 1", "Registered"),
                ("1-00002", "20250101", date(2025, 1, 1), "Name 2", "Registered"),
                ("1-00001", "20250201", date(2025, 2, 1), "Name 1", "Registered"),
                ("1-00002", "20250201", date(2025, 2, 1), "Name 2", "Registered"),
                ("1-00002", "20250201", date(2025, 2, 1), "Name 2", "Registered"),
            ],
            schema=pl.Schema(
                [
                    ...
                    ("cqc_provider_import_date", pl.Date),
                    ("name", pl.String),
