...
import projects._01_ingest.cqc_api.fargate.validate_cqc_providers_2_delta_flatten as job

PATCH_PATH = (
    "projects._01_ingest.cqc_api.fargate.validate_cqc_providers_2_delta_flatten"
)
...
class ValidateProvidersFlattenTests(unittest.TestCase):
    def setUp(self) -> None:
        self.validate_df = pl.DataFrame(
            [
                ("1-00001", "20240101", "Provider Name 1"),
                ("1-00002", "20240101", "Provider Name 2"),
                ("1-00001", "20240201", "Provider Name 1"),
                ("1-00002", "20240201", "Provider Name 2"),
                ("1-00002", "20240201", "Provider Name 2"),
            ],
            schema=pl.Schema(
                [
