...
import projects._01_ingest.cqc_api.fargate.validate_cqc_providers_1_delta_api_download as job

PATCH_PATH = (
    "projects._01_ingest.cqc_api.fargate.validate_cqc_providers_1_delta_api_download"
)
