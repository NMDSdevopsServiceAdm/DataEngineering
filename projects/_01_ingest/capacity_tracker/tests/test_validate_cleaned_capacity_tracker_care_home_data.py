...
PATCH_PATH: str = (
    "projects._01_ingest.capacity_tracker.jobs.validate_cleaned_capacity_tracker_care_home_data"
)


class ValidateCleanedCapacityTrackerCareHomeDatasetTests(SparkBaseTest):
