...
class CleanCapacityTrackerCareHomeData:
    capacity_tracker_care_home_rows = [
        ("loc 1", "1", "2", "3", "4", "5", "6", "20240101", "other data"),
    ]
...
class CleanCapacityTrackerNonResData:
    capacity_tracker_non_res_rows = [
        ("loc 1", "12", "300", "20240101", "other data"),
    ]
...
class ValidateCleanedCapacityTrackerCareHomeData:
    ct_care_home_rows = [
        ("1-000000001", "1", "2", "3", "4", "5", "6", "20240101"),
        ("1-000000002", "1", "2", "3", "4", "5", "6", "20240101"),
        ("1-000000001", "1", "2", "3", "4", "5", "6", "20240201"),
        ("1-000000002", "1", "2", "3", "4", "5", "6", "20240201"),
    ]

    # fmt: off
    cleaned_ct_care_home_rows = [
        ("1-000000001", "1", "2", "3", "4", "5", "6", date(2024, 1, 1), 6, 15, 21),
        ("1-000000002", "1", "2", "3", "4", "5", "6", date(2024, 1, 1), 6, 15, 21),
        ("1-000000001", "1", "2", "3", "4", "5", "6", date(2024, 2, 1), 6, 15, 21),
        ("1-000000002", "1", "2", "3", "4", "5", "6", date(2024, 2, 1), 6, 15, 21),
    ]
    # fmt: on
...
class ValidateCleanedCapacityTrackerNonResData:
    ct_non_res_rows = [
        ("1-000000001", "1", "2", "20240101"),
        ("1-000000002", "1", "2", "20240101"),
        ("1-000000001", "1", "2", "20240201"),
        ("1-000000002", "1", "2", "20240201"),
    ]

    cleaned_ct_non_res_rows = [
        ("1-000000001", "1", "2", date(2024, 1, 1)),
        ("1-000000002", "1", "2", date(2024, 1, 1)),
        ("1-000000001", "1", "2", date(2024, 2, 1)),
        ("1-000000002", "1", "2", date(2024, 2, 1)),
    ]
...
class CleanONSData:
    ons_sample_rows_full = [
        ("AB10AA", "104", "1", "38000006", "54000005", "1", "51.23456", "-.12345", "123", "10123", "20123", "1", "1000001", "2000001", "14000530", date(2022, 1, 1)),
        ("AB10AB", "104", "1", "38000006", "54000005", "1", "51.23456", "-.12345", "123", "10123", "20123", "1", "1000001", "2000001", "14000530", date(2022, 1, 1)),
        ("AB10AA", "999", "9", "38000265", "54000064", "40000012", "51.23456", "-.12345", "123", "10123", "20123", "9", "1035762", "2007116", "14001605", date(2023, 1, 1)),
        ("AB10AB", "999", "9", "38000265", "54000064", "40000012", "51.23456", "-.12345", "123", "10123", "20123", "9", "1035762", "2007116", "14001605", date(2023, 1, 1)),
        ("AB10AC", "999", "9", "38000265", "54000064", "40000012", "51.23456", "-.12345", "123", "10123", "20123", "9", "1035762", "2007116", "14001605", date(2023, 1, 1)),
    ] # fmt: skip
