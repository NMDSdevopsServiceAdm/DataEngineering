...
class ValidateCleanedCapacityTrackerCareHomeData:
    ...
    cleaned_ct_care_home_rows = [
        ("1-000000001", "1", "2", "3", "4", "5", "6", "20240101", date(2024, 1, 1), 6, 15, 21),
        ("1-000000002", "1", "2", "3", "4", "5", "6", "20240101", date(2024, 1, 1), 6, 15, 21),
        ("1-000000001", "1", "2", "3", "4", "5", "6", "20240201", date(2024, 2, 1), 6, 15, 21),
        ("1-000000002", "1", "2", "3", "4", "5", "6", "20240201", date(2024, 2, 1), 6, 15, 21),
    ]
    # fmt: on
