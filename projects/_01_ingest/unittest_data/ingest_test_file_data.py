...
class NullPeopleDirectlyEmployedData:
    null_people_directly_employed_outliers_rows = [
        ("1-0001", date(2025, 1, 1), "N", 15),
        ("1-0002", date(2025, 1, 1), "N", 150),
        ("1-0003", date(2024, 1, 1), "N", 5),
        ("1-0003", date(2025, 1, 1), "N", 9),
        ("1-0004", date(2024, 1, 1), "N", 500),
        ("1-0004", date(2025, 1, 1), "N", 505),
        ("1-0005", date(2024, 1, 1), "N", 1),
        ("1-0005", date(2024, 6, 1), "N", 49),
        ("1-0005", date(2025, 1, 1), "N", 100),
        ("1-0006", date(2024, 1, 1), "N", 40),
        ("1-0006", date(2024, 5, 1), "N", 200),
        ("1-0006", date(2024, 9, 1), "N", 100),
        ("1-0006", date(2025, 1, 1), "N", 150),
        ("1-0007", date(2025, 1, 1), "Y", 150),
    ]
    ...
    null_outliers_rows = [
        ...
        ("1-0003", date(2024, 6, 1), 49),
        ("1-0003", date(2025, 1, 1), 100),
        ("1-0004", date(2024, 1, 1), 40),
        ("1-0004", date(2024, 5, 1), 200),
        ("1-0004", date(2024, 9, 1), 100),
        ("1-0004", date(2025, 1, 1), 150),
    ]
    expected_null_outliers_rows = [
        ...
        ("1-0003", date(2024, 6, 1), None),
        ("1-0003", date(2025, 1, 1), None),
        ("1-0004", date(2024, 1, 1), None),
        ("1-0004", date(2024, 5, 1), None),
        ("1-0004", date(2024, 9, 1), None),
    ...
    expected_compute_dispersion_stats_rows = [
        ...
        ("1-0003", 100, 1, 50.0, 1.980),
        ("1-0004", 200, 40, 122.5, 1.306),
    ]
    ...
    expected_compute_median_rows = [
        ("1-0001", date(2024, 1, 1), 5, 5.0),
        ("1-0002", date(2024, 1, 1), 500, 502.5),
        ("1-0002", date(2025, 1, 1), 505, 502.5),
        ("1-0003", date(2024, 1, 1), 1, 49.0),
        ("1-0003", date(2024, 6, 1), 49, 49.0),
        ("1-0003", date(2025, 1, 1), 100, 49.0),
        ("1-0004", date(2024, 1, 1), 40, 125.0),
        ("1-0004", date(2024, 5, 1), 200, 125.0),
        ("1-0004", date(2024, 9, 1), 100, 125.0),
        ("1-0004", date(2025, 1, 1), 150, 125.0),
    ]
