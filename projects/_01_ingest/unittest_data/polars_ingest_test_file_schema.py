...
class ValidateCqcLocations4FullCleanTest:
    validation_schema = pl.Schema(
        [
            ...
            (CQCLClean.postcode_cleaned, pl.String()),
            (CQCLClean.contemporary_sub_icb, pl.String()),
            (CQCLClean.contemporary_icb, pl.String()),
            (CQCLClean.contemporary_icb_region, pl.String()),
            (CQCLClean.contemporary_latitude, pl.Float64()),
            (CQCLClean.contemporary_longitude, pl.Float64()),
            (CQCLClean.contemporary_imd_score, pl.Float64()),
            (CQCLClean.contemporary_lsoa11, pl.String()),
            (CQCLClean.contemporary_msoa11, pl.String()),
            (CQCLClean.contemporary_rural_urban_ind_11, pl.String()),
            (CQCLClean.contemporary_lsoa21, pl.String()),
            (CQCLClean.contemporary_msoa21, pl.String()),
            (CQCLClean.contemporary_constituency, pl.String()),
            (CQCLClean.current_sub_icb, pl.String()),
            (CQCLClean.current_icb, pl.String()),
            (CQCLClean.current_icb_region, pl.String()),
            (CQCLClean.current_latitude, pl.Float64()),
            (CQCLClean.current_longitude, pl.Float64()),
            (CQCLClean.current_imd_score, pl.Float64()),
            (CQCLClean.current_lsoa11, pl.String()),
            (CQCLClean.current_msoa11, pl.String()),
            (CQCLClean.current_rural_urban_ind_21, pl.String()),
