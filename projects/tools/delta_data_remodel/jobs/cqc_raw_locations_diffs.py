...
def main():
    ...
    write_folder = R"domain=CQC_delta/dataset=delta_locations_api/version=3.1.0/year=2013/month=03/day=01/import_date=20130301/file.parquet"
    ...
    for year in range(2013, 2026):
        for month in range(1, 13):
            ...
            for read_folder in sorted(day_folders):
                ...
                write_folder = Rf"domain=CQC_delta/dataset=delta_locations_api/version=3.1.0/year={year}/month={month:02}/day={day:02}/import_date={year}{month:02}{day:02}/"
