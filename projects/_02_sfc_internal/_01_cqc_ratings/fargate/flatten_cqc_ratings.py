...
def main(
    ...
    cqc_latest_delta_raw_lf = keep_latest_per_key(
    ...
    ascwds_workplace_lf = filter_to_first_import_of_most_recent_month(
        ascwds_workplace_lf
    )

    current_ratings_lf = prepare_current_ratings(cqc_ratings_lf)
    historic_ratings_lf = prepare_historic_ratings(cqc_ratings_lf)
    ...
    ratings_lf = merge_cqc_ratings(assessment_ratings_lf, ratings_pre_saf_lf)
    ...
    benchmark_ratings_lf = join_establishment_ids(
...
def filter_to_first_import_of_most_recent_month(lf: pl.LazyFrame) -> pl.LazyFrame:
    ...
    """
    lf = utils.filter_to_maximum_value_in_column(lf, Keys.year)
    lf = utils.filter_to_maximum_value_in_column(lf, Keys.month)
