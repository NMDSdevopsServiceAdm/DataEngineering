...
class FlattenCQCRatings:
    ...
    expected_flatten_assessment_ratings_rows = [
        ...
        # --- asg_ratings (AP001, Historic, Good) ---
        (
            "loc_1",
            "registered",
            "assessment_plan_published_datetime",
        ...
        # --- asg_ratings (AP002, Historic, Good) ---
        (
            "loc_1",
            "registered",
            "assessment_plan_published_datetime",
        ...
        # --- asg_ratings (AP003, Current, Good) ---
        (
            "loc_1",
            "registered",
            "assessment_plan_published_datetime",
        ...
        # --- asg_ratings (AP004, Current, Requires Improvement) ---
        (
            "loc_1",
            "registered",
            "assessment_plan_published_datetime",
        ...
        # --- asg_ratings (AP005, Historic, Requires Improvement) ---
        (
            "loc_1",
            "registered",
            "assessment_plan_published_datetime",
