...
class MainTests(unittest.TestCase):
    ...
    @patch(f"{PATCH_PATH}.mUtils.create_list_of_cols_and_schema_dict_for_ascwds")
    @patch(f"{PATCH_PATH}.utils.scan_parquet")
    def test_main_runs(
        self,
        scan_parquet_mock: Mock,
        create_list_of_cols_and_schema_dict_for_ascwds_mock: Mock,
        ...
        create_list_of_cols_and_schema_dict_for_ascwds_mock.assert_called_once()
