...
class TestShouldSeedRawBucket:
    ...
    def test_returns_false_when_only_unrelated_paths_changed(self):
        ...
        # Also includes one non-trigger file per ingest domain (a downstream
        # clean/validate-cleaned job, a test file, or a utils module) to guard
        # against the trigger list widening back out to a directory prefix.
        changed_paths = [
            "README.md",
