...
### Changed
- Migrated the Flatten CQC Ratings job from PySpark/Glue to Polars on the `_02_sfc_internal` shared Fargate task, renumbering its folder to `_01_cqc_ratings`, and added a validation job for its output.
