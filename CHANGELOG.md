...
- Restored the publication merge job's archive column selection and re-pointed its sample archive data sources to `run_number=2`, now that the sample archive data has been re-seeded to match the current schema.
