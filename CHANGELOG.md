...
- Moved `SLVJobRoleColumns` and `SLVEmploymentStatusColumns` into the shared `ind_cqc_pipeline_columns.py`, renaming them to `StartersLeaversVacanciesColumns` and `EmploymentStatusColumns` to reflect their actual scope.
