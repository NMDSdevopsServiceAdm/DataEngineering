    ...
    [
        ...
        StructField(
            ...
            ArrayType(
                StructType(
                    [
                        StructField("assessmentServiceId", StringType(), True),
                        StructField("assessmentServiceName", StringType(), True),
        ...
        StructField(
            ...
            ArrayType(
                StructType(
                    [
                        StructField(
                            NewColNames.assessment_plan_published_datetime,
                            StringType(),
                            True,
                        ),
                        StructField(
                                    ...
                                    StructField(
                                        ...
                                        ArrayType(
                                            StructType(
                                                [
                                                    StructField(
                                                        NewColNames.assessment_plan_id,
                                                        StringType(),
                                                        True,
                                                    ),
                                                    StructField(
