...
class CleanedIndCqcValidationRules:
    rules_to_check = {
        ...
        RuleName.categorical_values_in_columns: {
            ...
            IndCqcColumns.specialism_dementia: CatValues.specialism_dementia_column_values.categorical_values,
            IndCqcColumns.specialism_learning_disabilities: CatValues.specialism_learning_disabilities_column_values.categorical_values,
            IndCqcColumns.specialism_mental_health: CatValues.specialism_mental_health_column_values.categorical_values,
        },
        RuleName.distinct_values: {
            ...
            IndCqcColumns.specialism_dementia: CatValues.specialism_dementia_column_values.count_of_categorical_values,
            IndCqcColumns.specialism_learning_disabilities: CatValues.specialism_learning_disabilities_column_values.count_of_categorical_values,
            IndCqcColumns.specialism_mental_health: CatValues.specialism_mental_health_column_values.count_of_categorical_values,
        },
