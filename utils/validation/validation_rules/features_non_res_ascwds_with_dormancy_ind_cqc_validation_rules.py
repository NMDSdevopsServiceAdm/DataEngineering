...
class NonResASCWDSWithDormancyIndCqcFeaturesValidationRules:
    rules_to_check = {
        ...
        RuleName.complete_columns: [
            ...
            IndCqcColumns.months_since_not_dormant_capped_at_10_years,
        ...
        RuleName.min_values: {
            ...
            IndCqcColumns.months_since_not_dormant_capped_at_10_years: 1.0,
        ...
        RuleName.max_values: {
            ...
            IndCqcColumns.months_since_not_dormant_capped_at_10_years: 120.0,
        },
