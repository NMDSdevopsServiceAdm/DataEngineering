...
class EstimatedIndCqcFilledPostsValidationRules:
    rules_to_check = {
        ...
        RuleName.min_values: {
            ...
            IndCqcColumns.imputed_posts_rolling_average_model: 0.0,
            IndCqcColumns.imputed_ratio_rolling_average_model: 0.0,
        ...
        RuleName.max_values: {
            ...
            IndCqcColumns.imputed_posts_rolling_average_model: 3000.0,
            IndCqcColumns.imputed_ratio_rolling_average_model: 3000.0,
