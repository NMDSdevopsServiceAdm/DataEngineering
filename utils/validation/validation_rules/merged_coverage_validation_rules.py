...
class MergedCoverageValidationRules:
    rules_to_check = {
        ...
        RuleName.min_values: {
            ...
            CoverageColumns.la_monthly_coverage: 0,
            CoverageColumns.coverage_monthly_change: 0,
            CoverageColumns.locations_monthly_change: 0,
            CoverageColumns.new_registrations_monthly: 0,
            CoverageColumns.new_registrations_ytd: 0,
        },
        RuleName.max_values: {
            CoverageColumns.in_ascwds: 1,
            CoverageColumns.la_monthly_coverage: 1,
            CoverageColumns.coverage_monthly_change: 1,
        },
