...
class EstimatedIndCqcFilledPostsValidationRules:
    rules_to_check = {
        ...
        RuleName.min_values: {
            ...
            IndCqcColumns.non_res_pir_linear_regression_model: 1,
        ...
        RuleName.max_values: {
            ...
            IndCqcColumns.people_directly_employed_dedup: 3000,
            IndCqcColumns.non_res_pir_linear_regression_model: 3000,
