...
class EstimatedIndCqcFilledPostsValidationRules:
    rules_to_check = {
        ...
        RuleName.min_values: {
            ...
            IndCqcColumns.care_home_rolling_average_model: 1.0,
            IndCqcColumns.estimate_filled_posts: 1.0,
            IndCqcColumns.non_res_combined_model: 1.0,
        ...
        RuleName.max_values: {
            ...
            IndCqcColumns.care_home_rolling_average_model: 3000.0,
            IndCqcColumns.estimate_filled_posts: 3000.0,
            IndCqcColumns.non_res_combined_model: 3000.0,
