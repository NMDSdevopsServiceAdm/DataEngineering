...
def model_primary_service_rolling_average(
    ...
    posts_posts_rolling_average_model_column_name: str,
) -> DataFrame:
    """
    ...
    additional columns will be added with the column names 'posts_posts_rolling_average_model_column_name' and 'ratio_rolling_average_model_column_name'.
    ...
    Args:
        ...
        posts_posts_rolling_average_model_column_name (str): The name of the new column to store the filled posts rolling average.
    ...
    df = create_final_model_columns(
        ...
        posts_posts_rolling_average_model_column_name,
    )
...
def create_final_model_columns(
    ...
    `posts_posts_rolling_average_model_column_name` replicates what is in the `temp_rolling_average` for non-care homes and for care homes, the column is multiplied by number of beds to get the equivalent filled posts.
