...
def total_staff_or_worker_record_count_less_than_permitted_minimum():
    return ((F.col("total_staff") < JobCalculationConstants().MIN_TOTAL_STAFF_VALUE_PERMITTED)
            | (F.col("worker_record_count") < JobCalculationConstants().MIN_WORKER_RECORD_COUNT_PERMITTED))
