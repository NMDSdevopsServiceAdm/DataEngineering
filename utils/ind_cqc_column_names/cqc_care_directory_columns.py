...
class CqcCareDirectoryColumns:
    ...
    class ServiceType:
        ...
        care_home_without_nursing:str ="Service_type_Care_home_service_without_nursing"
        community_substance_misuse:str = "Service_type_Community_based_services_for_people_who_misuse_substances"
        community_learning_disability: str ="Service_type_Community_based_services_for_people_with_a_learning_disability"
        community_mental_health:str = "Service_type_Community_based_services_for_people_with_mental_health_needs"
        nursing_agency:str = "Service_type_Community_health_care_services_Nurses_Agency_only"
    ...
    class ServiceUserBand:
        ...
        learning_disabilities_autism:str = "Service_user_band_Learning_disabilities_or_autistic_spectrum_disorder"
        mental_health:str = "Service_user_band_Mental_Health"
        older_people:str ="Service_user_band_Older_People"
        mental_health_act:str = "Service_user_band_People_detained_under_the_Mental_Health_Act"
        misuse_drugs_alcohol:str = "Service_user_band_People_who_misuse_drugs_and_alcohol"
