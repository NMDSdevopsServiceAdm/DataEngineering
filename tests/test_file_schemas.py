...
class DiagnosticsOnCapacityTrackerSchemas:
    estimate_filled_posts_schema = StructType(
        [
            ...
            StructField(IndCQC.unix_time, IntegerType(), True),
            StructField("ct_care_home_import_date", DateType(), True),
            StructField("ct_care_home_total_employed", IntegerType(), True),
            StructField("ct_non_res_import_date", DateType(), True),
            StructField("ct_non_res_care_workers_employed", IntegerType(), True),
            StructField(Keys.year, StringType(), True),
            StructField(Keys.month, StringType(), True),
            StructField(Keys.day, StringType(), True),
            StructField(Keys.import_date, StringType(), True),
