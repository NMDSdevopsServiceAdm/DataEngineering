...
class TestSpssJobEstimatesSchema(unittest.TestCase):
    ...
    def test_schema_structure_is_as_expected(self):
        ...
        expected_schema_structure = [{'name': 'LOCATIONID', 'type': 'string', 'nullable': True, 'metadata': {}},
                                     {'name': 'Main_Service_Group', 'type': 'integer', 'nullable': False,
                                      'metadata': {}},
                                     {'name': 'Care_homes_beds', 'type': 'float', 'nullable': False, 'metadata': {}},
                                     {'name': 'WEIGHTING_CSSR', 'type': 'integer', 'nullable': False, 'metadata': {}},
                                     {'name': 'WEIGHTING_REGION', 'type': 'integer', 'nullable': False, 'metadata': {}},
                                     ...
                                     {'name': 'Snapshot_date', 'type': 'date', 'nullable': True, 'metadata': {}},
                                     {'name': 'Local_authority', 'type': 'string', 'nullable': False, 'metadata': {}},
                                     {'name': 'Region', 'type': 'string', 'nullable': False, 'metadata': {}},
                                     {'name': 'Main_service', 'type': 'string', 'nullable': False, 'metadata': {}},
                                     {'name': 'Data_used_string', 'type': 'string', 'nullable': False, 'metadata': {}}]
