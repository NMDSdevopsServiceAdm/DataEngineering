...
class TestJobCalculator(unittest.TestCase):
    ...
    def test_calculate_jobcount(self):
        ...
        self.assertEqual(jobcount_df_list[2]["job_count_source"], None)

        self.assertEqual(jobcount_df_list[3]["job_count"], 10.0)
        self.assertEqual(jobcount_df_list[3]["job_count_source"], None)
        ...
        self.assertEqual(jobcount_df_list[8]["job_count_source"], "tiny_values")
