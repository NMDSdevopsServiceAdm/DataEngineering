...
class EstimateIndCQCFilledPostsTests(unittest.TestCase):
    ...
    @patch(
        f"{PATCH_PATH}.FPutils.overwrite_estimate_filled_posts_with_imputed_estimate_filled_posts_at_point_of_becoming_non_dormant"
    )
    ...
    def test_main_runs(
        ...
        overwrite_estimate_filled_posts_with_imputed_estimate_filled_posts_at_point_of_becoming_non_dormant_mock: Mock,
        ...
        overwrite_estimate_filled_posts_with_imputed_estimate_filled_posts_at_point_of_becoming_non_dormant_mock.assert_called_once()
