  ...
  TEST_WORKER_FILE = "tests/test_data/domain=CQC/dataset=worker/format=parquet/worker_file.parquet"
   ...
   def setUp(self):
    ...
    def test_get_comprehensive_list_of_job_roles_to_locations(self):
        ...
        master_columns = ["master_locationid", "primary_service_type",
                          "estimate_job_count_2021", "location_worker_records"]
        master_rows = [
        ...
        self.assertEqual(
            ouput_df.columns,
            ["master_locationid", "primary_service_type",
                "estimate_job_count_2021", "location_worker_records", "main_job_role"]
        )
