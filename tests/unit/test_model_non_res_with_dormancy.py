...
@patch("utils.estimate_filled_posts.models.non_res_with_dormancy.save_model_metrics")
...
def test_model_non_res_with_dormancy_returns_expected_data(
    ...
    self.assertIsNotNone(expected_location_with_prediction.non_res_with_dormancy_model)
    self.assertIsNone(expected_location_without_prediction.non_res_with_dormancy_model)
