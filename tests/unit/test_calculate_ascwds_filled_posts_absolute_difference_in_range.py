...
import utils.ind_cqc_filled_posts_utils.ascwds_filled_posts_calculator.calculate_ascwds_filled_posts_absolute_difference_within_range as job
...
class TestAscwdsFilledPostsAbsoluteDiffInRange(unittest.TestCase):
    def setUp(self):
        ...
        self.df = job.calculate_ascwds_filled_posts_absolute_difference_within_range(
    ...
    def test_calculate_ascwds_filled_posts_absolute_difference_within_range_sources(
        ...
        self.assertEqual(
            ...
            job.ascwds_filled_posts_absolute_difference_within_range_source_description,
        )
