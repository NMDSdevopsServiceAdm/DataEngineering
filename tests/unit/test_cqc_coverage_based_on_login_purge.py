...
class PrepareLocationsTests(unittest.TestCase):
    ...
    def setUp(self):
        self.spark = SparkSession.builder.appName("test_cqc_coverage_based_on_login_purge").getOrCreate()
    ...
    def test_get_cqc_location_df(self):
        cqc_location_df = cqc_coverage_based_on_login_purge.get_cqc_location_df(self.TEST_CQC_LOCATION_FILE, "20200101")
    ...
    def test_get_date_closest_to_search_date_returns_correct_date(self):
        ...
        result = cqc_coverage_based_on_login_purge.get_date_closest_to_search_date(test_date, date_search_list)
    ...
    def test_get_unique_import_dates_from_cqc_location_dataset(self):
        cqc_location_df = cqc_coverage_based_on_login_purge.get_cqc_location_df(self.TEST_CQC_LOCATION_FILE, "20210101")

        result = cqc_coverage_based_on_login_purge.get_unique_import_dates(cqc_location_df)
    ...
    def test_get_cqc_location_df_standardises_yorkshire_and_the_humber_region(self):
        cqc_locations = cqc_coverage_based_on_login_purge.get_cqc_location_df(self.TEST_CQC_LOCATION_FILE)
