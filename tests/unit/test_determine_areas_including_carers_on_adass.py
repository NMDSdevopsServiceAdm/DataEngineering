...
class TestDetermineAreasIncludingCarers(unittest.TestCase):
    ...
    def test_determine_aread_including_carers_on_adass_returns_correct_columns(
        ...
        self.assertEqual(output_df_list[0][DP.PROPORTION_OF_SERVICE_USERS_EMPLOYING_STAFF], 0.5001596807238414)
        self.assertEqual(output_df_list[1][DP.PROPORTION_OF_SERVICE_USERS_EMPLOYING_STAFF], 0.25063872289536593)
