...
class TestDetermineAreasIncludingCarers(unittest.TestCase):
    ...
    def test_calculate_carers_employing_staff_returns_correct_product(self):
        ...
        self.assertAlmostEqual(output_df_list[0][DP.CARERS_EMPLOYING_STAFF], 0.0127744579073184, places=5)
        self.assertAlmostEqual(output_df_list[1][DP.CARERS_EMPLOYING_STAFF], 0.063872289536592, places=5)
