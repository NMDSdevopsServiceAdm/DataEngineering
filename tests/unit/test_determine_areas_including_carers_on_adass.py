...
class TestDetermineAreasIncludingCarers(unittest.TestCase):
    ...
    def test_calculate_carers_employing_staff_returns_correct_product(self):
        ...
        self.assertEqual(
            output_df_list[0][DP.CARERS_EMPLOYING_STAFF_AT_YEAR_END], 0.0127744579073184
        )
        self.assertEqual(
            output_df_list[1][DP.CARERS_EMPLOYING_STAFF_AT_YEAR_END], 0.063872289536592
        )
    ...
    def test_allocate_method_for_calculating_service_users_employing_staff_returns_correct_value(
        ...
        self.assertEqual(
            output_df_list[0][DP.METHOD], job.ADASS_DOES_NOT_INCLUDE_CARERS
        )
