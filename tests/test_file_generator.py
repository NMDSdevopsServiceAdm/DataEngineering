...
def generate_prepared_locations_file_parquet(output_destination):
    ...
    rows = [
        ...
        ("1-1334987222", "South West",  2, True,["Domiciliary care service"]),
        ("1-348374832", "Merseyside",  2, True,["Extra Care housing services"]),
        ("1-683746776", "Merseyside",  2, True,["Doctors treatment service","Long term conditions services","Shared Lives"]),
        ("1-10478686 ", "London Senate",  2, True,["Community health care services - Nurses Agency only"]),
        ("1-10235302415", "South West",  2, True,["Urgent care services", "Supported living service"]),
        ("1-1060912125", "Yorkshire and The Humbler",  2, True,["Acute services with overnight beds"]),
        ("1-107095666", "Yorkshire and The Humbler",  2, True,["Specialist college service","Community based services for people who misuse substances","Urgent care services'"]),
        ("1-108369587", "South West",  2, True,["Specialist college service"]),
        ("1-10758359583", "Yorkshire and The Humbler",  2, True,["Mobile doctors service"]),
        ("1-108387554", "Yorkshire and The Humbler",  2, True,["Doctors treatment service", "Hospice services at home"]),
        ("1-10894414510", "Yorkshire and The Humbler",  2, True,["Care home service with nursing"]),
        ("1-108950835", "Merseyside",  2, True,["Care home service without nursing'"]),
        ("1-108967195", "Merseyside",  2, True,["Domiciliary care service"]),
    ]
    # fmt: on
