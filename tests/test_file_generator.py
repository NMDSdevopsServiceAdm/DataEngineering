...
def generate_ascwds_workplace_file(output_destination):
    ...
    rows = [
        ("1-000000001", "101", 14, 16, "20200101", "1", date(2021, 2, 1), 0, "201"),
        ("1-000000002", "102", 76, 65, "20200101", "1", date(2021, 4, 1), 1, None),
        ("1-000000003", "103", 34, 34, "20200101", "2", date(2021, 3, 1), 0, "203"),
        ("1-000000004", "104", 234, 265, "20190101", "2", date(2021, 4, 1), 0, None),
        ("1-000000005", "105", 62, 65, "20190101", "3", date(2021, 10, 1), 0, None),
        ("1-000000006", "106", 77, 77, "20190101", "3", date(2020, 3, 1), 1, None),
        ("1-000000007", "107", 51, 42, "20190101", "3", date(2021, 5, 1), 0, None),
        ("1-000000008", "108", 36, 34, "20190101", "4", date(2021, 7, 1), 0, None),
        ("1-000000009", "109", 34, 32, "20190101", "5", date(2021, 12, 1), 0, None),
        ("1-0000000010", "110", 14, 20, "20190101", "6", date(2021, 3, 1), 0, None),
        ("1-000000001", "101", 14, 16, "20220101", "1", date(2021, 2, 1), 0, None),
        ("1-000000002", "102", 76, 65, "20220101", "1", date(2021, 4, 1), 1, None),
        ("1-000000003", "103", 34, 34, "20220101", "2", date(2021, 3, 1), 0, None),
        ("1-000000004", "104", 234, 265, "20220101", "2", date(2021, 4, 1), 0, None),
        ("1-000000005", "105", 62, 65, "20210101", "3", date(2021, 10, 1), 0, None),
        ("1-000000006", "106", 77, 77, "20210101", "3", date(2020, 3, 1), 1, None),
        ("1-000000007", "107", 51, 42, "20210101", "3", date(2021, 5, 1), 0, None),
        ("1-000000008", "108", 36, 34, "20210101", "4", date(2021, 7, 1), 0, None),
        ("1-000000009", "109", 34, 32, "20210101", "5", date(2021, 12, 1), 0, None),
        ("1-0000000010", "110", 14, 20, "20210101", "6", date(2021, 3, 1), 0, None),
    ]
...
def generate_acswds_workplace_structure_file(output_destination):
    ...
    ascwds_schema = StructType(
        fields=[
            StructField("isparent", StringType(), True),
