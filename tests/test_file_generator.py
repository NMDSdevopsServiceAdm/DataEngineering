...
def generate_prepared_locations_file_parquet(
    ...
    # fmt: off
    rows = [
        ("1-1783948", "20220201", "South East", 0, ["Domiciliary care service"], 5, None, "Surrey", partitions[0], partitions[1], partitions[2], "Y", "Independent", {"year_2011": "(England/Wales) Rural hamlet and isolated dwellings in a sparse setting"}),
        ("1-1783948", "20220101", "South East", 0, ["Domiciliary care service"], 5, 67, "Surrey", partitions[0], partitions[1], partitions[2], "Y", "Independent", {"year_2011": "(England/Wales) Rural hamlet and isolated dwellings in a sparse setting"}),
        ("1-348374832", "20220112", "Merseyside", 0, ["Extra Care housing services"], 23, 34, "Gloucestershire", partitions[0], partitions[1], partitions[2], "N", "Local authority", {"year_2011": "(England/Wales) Rural hamlet and isolated dwellings"}),
        ...
        ("1-10478686 ", "20220101", "London Senate", 0, ["Community health care services - Nurses Agency only"], 4, None, "Surrey", partitions[0], partitions[1], partitions[2], "N", "", {"year_2011": "(England/Wales) Rural hamlet and isolated dwellings"}),
        ...
        ("1-1060912125", "20220112", "Yorkshire and The Humbler", 0, ["Hospice services at home"], 34, None, "Surrey", partitions[0], partitions[1], partitions[2], "Y", "Independent", {"year_2011": "(England/Wales) Rural hamlet and isolated dwellings"}),
        ...
        ("1-000000001", "20220308", "Yorkshire and The Humbler", 67, ["Care home service with nursing"], None, None, "Lewisham", partitions[0], partitions[1], partitions[2], "N", "Local authority", {"year_2011": "(England/Wales) Urban city and town"}),
        ("1-10894414510", "20220308", "Yorkshire and The Humbler", 10, ["Care home service with nursing"], 0, 25, "Lewisham", partitions[0], partitions[1], partitions[2], "N", "Independent", {"year_2011": "(England/Wales) Urban city and town"}),
        ...
        ("1-108967195", "20220422", "(pseudo) Wales", 0, ["Supported living service", "Acute services with overnight beds"], 11, None, "Lewisham", partitions[0], partitions[1], partitions[2], "Y", "Independent", {"year_2011": "(England/Wales) Urban city and town"}),
    ]
    # fmt: on
