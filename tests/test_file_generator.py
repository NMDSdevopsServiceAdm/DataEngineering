...
def generate_prepared_locations_file_parquet(
    ...
    rows = [
        ...
        ("1-108387554", "20220308", "Yorkshire and The Humbler", 2, ["Doctors treatment service", "Hospice services at home"], None, None, "Lewisham", partitions[0], partitions[1], partitions[2], "N", "Local authority", {"2011": "(England/Wales) Urban city and town"}),
        ("1-10894414510", "20220308", "Yorkshire and The Humbler", 2, ["Care home service with nursing"], 0, None, "Lewisham", partitions[0], partitions[1], partitions[2], "N", "Independent", {"2011": "(England/Wales) Urban city and town"}),
