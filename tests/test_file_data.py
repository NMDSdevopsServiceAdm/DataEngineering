...
class PrepareNonResData(object):
    ...
    rows = [
        ...
        ("1-348374832", date(2022, 1, 12), "Merseyside", 0, ["Extra Care housing services"], "non-residential", None, 34.0, 34.0, "Gloucestershire",  "N", "Local authority", "(England/Wales) Rural hamlet and isolated dwellings", "rule_3", "Registered", '2022', '02', '01', '20220201'),
        ("1-683746776", date(2022, 1, 1), "Merseyside", 0, ["Doctors treatment service", "Long term conditions services", "Shared Lives"], "non-residential", 34, None, None, "Gloucestershire",  "N", "Local authority", "(England/Wales) Rural hamlet and isolated dwellings", "rule_1", "Registered", '2022', '01', '01', '20220101'),
        ("1-10478686", date(2022, 1, 1), "London Senate", 0, ["Community health care services - Nurses Agency only"], "non-residential", None, None, None, "Surrey",  "N", "", "(England/Wales) Rural hamlet and isolated dwellings", "rule_1", "Registered", '2022', '01', '01', '20220101'),
        ...
        ("1-10758359583", date(2022, 3, 8), None, 0, ["Mobile doctors service"], "non-residential", 17, None, None, "Lewisham",  "N", "Local authority", "(England/Wales) Urban city and town", "rule_2", "Registered", '2022', '03', '08', '20220308'),
