...
class DiagnosticsOnKnownFilledPostsData:
    ...
    expected_calculate_aggregate_residuals_rows = [
        ("loc 1", PrimaryServiceType.care_home_only, EstimateFilledPostsSource.care_home_model, 10.0, 0.1, 0.9, 15.0, 0.15, 20.0, 0.5, 1.0),
        ("loc 2", PrimaryServiceType.care_home_only, EstimateFilledPostsSource.care_home_model, 20.0, 0.2, 1.0, 15.0, 0.15, 20.0, 0.5, 1.0),
        ("loc 3", PrimaryServiceType.care_home_with_nursing, EstimateFilledPostsSource.care_home_model, 30.0, 0.3, 1.1, 35.0, 0.35, 40.0, 0.0, 0.5),
        ("loc 4", PrimaryServiceType.care_home_with_nursing, EstimateFilledPostsSource.care_home_model, 40.0, 0.4, 1.2,  35.0, 0.35, 40.0, 0.0, 0.5),
        ("loc 5", PrimaryServiceType.care_home_with_nursing, EstimateFilledPostsSource.interpolation_model, 50.0, 0.5, 1.3, 55.0, 0.55, 60.0, 0.0, 0.0),
        ("loc 6", PrimaryServiceType.care_home_with_nursing, EstimateFilledPostsSource.interpolation_model, 60.0, 0.6, 1.4, 55.0, 0.55, 60.0, 0.0, 0.0),
    ]
