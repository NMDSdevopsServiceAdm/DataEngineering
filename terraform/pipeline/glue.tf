...
module "flatten_cqc_ratings_job" {
  ...
  job_parameters = {
    ...
    "--cqc_assessment_ratings_destination"       = "${module.datasets_bucket.bucket_uri}/domain=SfC/dataset=sfc_cqc_assessment_ratings_for_data_requests/version=2.0.0/"
  }
}
...
module "validate_locations_api_raw_delta_data_job" {
  source          = "../modules/glue-job"
  script_dir      = "projects/_01_ingest/cqc_api/jobs"
  script_name     = "validate_locations_api_raw_delta_data.py"
  glue_role       = aws_iam_role.sfc_glue_service_iam_role
  resource_bucket = module.pipeline_resources
  datasets_bucket = module.datasets_bucket
  glue_version    = "4.0"
