...
resource "aws_sfn_state_machine" "sf_pipelines" {
  ...
  definition = templatefile(each.value, {
    ...
    empstat_diagnostics_task_arn   = module._03_independent_cqc_empstat_diagnostics.task_arn
    ...
    empstat_diagnostics_security_group_id   = module._03_independent_cqc_empstat_diagnostics.security_group_id
    ...
    "Statement" : [
      ...
      },
      {
        ...
        "Resource" : [
          ...
          module._03_independent_cqc_empstat_diagnostics.task_arn,
      ...
      },
      {
        ...
        Resource = [
          ...
          module._03_independent_cqc_empstat_diagnostics.task_exc_role_arn,
          module._03_independent_cqc_empstat_diagnostics.task_role_arn
        ],
        Condition = {
          StringLike = {
            "iam:PassedToService" = [
