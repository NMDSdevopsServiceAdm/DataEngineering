resource "aws_sfn_state_machine" "ind_cqc_filled_post_estimates_pipeline_state_machine" {
  ...
  definition = templatefile("step-functions/IndCqcFilledPostEstimatePipeline-StepFunction.json", {
    ...
    estimate_non_ml_ind_cqc_filled_posts_job_name      = module.estimate_non_ml_ind_cqc_filled_posts_job.job_name
    ...
    estimate_ml_ind_cqc_filled_posts_job_name          = module.estimate_ml_ind_cqc_filled_posts_job.job_name
...
resource "aws_sfn_state_machine" "gold_validation_state_machine" {
  ...
  definition = templatefile("step-functions/GoldValidationPipeline-StepFunction.json", {
    ...
    validate_estimated_ml_ind_cqc_filled_posts_data_job_name                = module.validate_estimated_ml_ind_cqc_filled_posts_data_job.job_name
