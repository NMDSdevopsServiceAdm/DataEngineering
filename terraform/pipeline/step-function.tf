...
resource "aws_sfn_state_machine" "sf_pipelines" {
  ...
  definition = templatefile(each.value, {
    ...
    ascwds_oom_diag_task_arn           = module.ascwds_oom_diag.task_arn
    ...
    ascwds_oom_diag_security_group_id           = module.ascwds_oom_diag.security_group_id
    ...
    "Statement" : [
      ...
      },
      {
        ...
        "Resource" : [
          ...
          module.ascwds_oom_diag.task_arn,
      ...
      },
      {
        ...
        Resource = [
          ...
          module.ascwds_oom_diag.task_exc_role_arn,
          module.ascwds_oom_diag.task_role_arn,
