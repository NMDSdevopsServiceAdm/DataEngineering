...
resource "aws_sfn_state_machine" "sf_pipelines" {
  ...
  definition = templatefile(each.value, {
    ...
    ascwds_export_dup_rows_task_arn    = module.ascwds_export_dup_rows.task_arn
    ...
    ascwds_export_dup_rows_security_group_id    = module.ascwds_export_dup_rows.security_group_id
    ...
    "Statement" : [
      ...
      },
      {
        ...
        "Resource" : [
          ...
          module.ascwds_export_dup_rows.task_arn,
      ...
      },
      {
        ...
        Resource = [
          ...
          module.ascwds_export_dup_rows.task_exc_role_arn,
          module.ascwds_export_dup_rows.task_role_arn,
