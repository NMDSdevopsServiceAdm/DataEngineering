...
resource "aws_sfn_state_machine" "sf_pipelines" {
  ...
  definition = templatefile(each.value, {
    ...
    cqc_pir_task_arn                   = module.cqc-pir.task_arn
    ...
    cqc_pir_security_group_id                   = module.cqc-pir.security_group_id
    ...
    "Statement" : [
      ...
      },
      {
        ...
        Resource = [
          ...
          module.cqc-pir.task_exc_role_arn,
          module.cqc-pir.task_role_arn,
